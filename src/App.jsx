...
const App = () => {
  return (
    <>
      ...
      <main className="flex bg-[#f1f3f6] h-screen sm:p-[8px] overflow-y-auto hide-scrollbar">
        <section className="w-[370px] pr-[10px] hidden sm:block">
        ...
        <section className="bg-white w-full shadow h-screen overflow-auto  hide-scrollbar ">
          <div className="hidden sm:block">
            <Navigation />
          </div>
